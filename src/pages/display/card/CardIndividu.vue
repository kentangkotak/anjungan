<template>
  <div style="height:60%">
    ...
    <q-card class="my-card"  v-else>
      <q-card-section :class="`bg-${colors[7]} text-white`">
        <div class="text-center text-weight-bold" :style="`font-size: ${app.txtXl}px;`">LOKET -</div>
        <div class="text-center" :style="`font-size: ${app.txtH5}px; margin-top:-5px;`">--------------------</div>
      </q-card-section>

      <q-separator />
      <q-card-section class="">
        <div class="text-center" :style="`font-size: ${app.txtH5}px;`">NO AVAILABLE</div>
